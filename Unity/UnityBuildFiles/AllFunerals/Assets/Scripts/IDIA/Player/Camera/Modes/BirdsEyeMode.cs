...
/// <summary>
/// This class handles the birds eye mode of the player camera for funeral visualizations.
/// In particular, this is the only camera mode for these visualizations and allow
...
public class BirdsEyeMode : IPlayerCameraMode {
	...
	/// <summary>
	/// The starting "zoom" - 0 is fully zoomed out, 100 is zoomed in.
	/// </summary>
    ...
    void CheckMouseWheel() {
		//Scroll at a rate that increases further out, based
		//on the mouse wheel.
    ...
    /// <summary>
    /// A method to check the arrow keys.
    /// </summary>
    void CheckArrowKeys() {
		//In this mode, the arrow keys do not change camera styles.
    ...
    /// </summary>
    void UpdateCamera() {
		//Make use of zoom and the player's position/rotation to correctly position the camera.
		//These values are absolute, not relative.
